...
df_nearestBusStation = pd.read_csv("D:\juniorSpring\DS\TermP\\nearest_busStation.csv", encoding='euc-kr')
df_nearestBusStation = df_nearestBusStation[['전철역코드', '외부코드', '전철역명', '호선', '정류장명', '정류장ID']]

df_BusStation2201 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202201.csv", encoding='euc-kr')
# df_BusStation2202 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202202.csv", encoding='euc-kr')
# df_BusStation2203 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202203.csv", encoding='euc-kr')
# df_BusStation2204 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202204.csv", encoding='euc-kr')
# df_BusStation2205 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202205.csv", encoding='euc-kr')
# df_BusStation2206 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202206.csv", encoding='euc-kr')
# df_BusStation2207 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202207.csv", encoding='euc-kr')
# df_BusStation2208 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202208.csv", encoding='euc-kr')
# df_BusStation2209 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202209.csv", encoding='euc-kr')
# df_BusStation2210 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202210.csv", encoding='euc-kr')
# df_BusStation2211 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202211.csv", encoding='euc-kr')
# df_BusStation2212 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202212.csv", encoding='euc-kr')
# df_BusStation2301 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202301.csv", encoding='euc-kr')
# df_BusStation2302 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202302.csv", encoding='euc-kr')
# df_BusStation2303 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202303.csv", encoding='euc-kr')
# df_BusStation2304 = pd.read_csv("D:\juniorSpring\DS\TermP\\busStation\\busStation202304.csv", encoding='euc-kr')
...
df_BusStation2201.to_csv("D:\juniorSpring\DS\TermP\\test1.csv")
...
print(df_BusStation2201.head())
df_BusStation2201.to_csv("D:\juniorSpring\DS\TermP\\test2.csv")
...
def mergedf(df):
    ...
    df = df.groupby(['전철역코드', '전철역명', '호선', '사용일자'])['승차총승객수', '하차총승객수'].sum().reset_index()
...
df_BusStation2201.to_csv("D:\juniorSpring\DS\TermP\\sum_dataset.csv")